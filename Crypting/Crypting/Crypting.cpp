...
void Encrypt()
{
    ...
    ReadFile("C:/chipher_text_brute_force", plainText);
    ...
    WriteFile("C:/chipher_text_brute_force", chipherText);

    AppendToFile("C:/chipher_text_brute_force", hash); //32 bytes HASH base file
}
